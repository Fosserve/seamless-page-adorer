...
const HeroSection = () => {
  return (
    <section className="relative bg-blue-600 overflow-hidden">
      ...
      {/* Main Content */}
      <div className="min-h-screen flex flex-col items-center justify-center relative z-10 py-16">
        <div className="container mx-auto px-4 text-center text-white">
          <h1 className="text-5xl md:text-6xl font-bold mb-6 animate-fade-in">
            <span className="block mb-3">Welcome to</span>
          ...
          <p className="text-xl md:text-2xl mb-10 max-w-3xl mx-auto animate-slide-up opacity-0" style={{animationDelay: '0.3s'}}>
            Adarsh English Medium School has over 2,000+ years of educational excellence.<br/>
            Your child to inspire by learning - Get Destination to discover dreams
          </p>
          <button className="bg-yellow-500 text-blue-900 font-semibold px-8 py-4 rounded-full shadow-lg hover:bg-yellow-400 transform hover:scale-105 transition-all duration-300 animate-slide-up opacity-0 text-lg" style={{animationDelay: '0.6s'}}>
            ENROLL NOW
          </button>
        </div>
        ...
        <div className="w-full max-w-5xl mx-auto mt-16 px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="rounded-lg overflow-hidden border-4 border-yellow-400 shadow-lg transform hover:scale-105 transition-transform duration-300">
              <img 
